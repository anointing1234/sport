"""
Django settings for Soccer_bet project.
...
ALLOWED_HOSTS = ["https://sport-production.up.railway.app/"]
...
ROOT_URLCONF = 'Soccer_bet.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR,'Soccer_app','templates','accounts','templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
